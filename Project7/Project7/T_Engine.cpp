...
BOOL T_Engine::GameWinInit()
{
	...
	gamewin.lpfnWndProc		= (WNDPROC)WndProc;
	gamewin.cbClsExtra		= 0;
	gamewin.cbWndExtra		= 0;
	gamewin.hInstance		= m_hInstance;
	gamewin.hIcon			= LoadIcon(m_hInstance, MAKEINTRESOURCE(IDI_SHARK));
	...
	gamewin.hIconSm		= LoadIcon(m_hInstance, MAKEINTRESOURCE(IDI_SHARK));
